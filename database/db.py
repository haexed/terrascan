...
if not DATABASE_URL:
    raise ValueError("❌ DATABASE_URL environment variable is required. Terrascan uses PostgreSQL for both development and production. See README.md for setup instructions.")
